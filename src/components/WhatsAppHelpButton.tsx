...
export function WhatsAppHelpButton({ phone, label = 'Need Help? Chat with us' }: Props) {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-[9985] flex items-center gap-2">
      ...
      <Link
        ...
        className="flex h-14 w-14 shrink-0 items-center justify-center rounded-full bg-[#25D366] shadow-[0_4px_14px_rgba(0,0,0,0.2)] transition hover:scale-105 hover:bg-[#20bd5a]"
        aria-label={label}
      >
        <WhatsAppIcon />
      </Link>
